...
public class StructureRestController {
	...
	public ResponseEntity<StructureDTO> delete(@PathVariable int id) throws OperationFailedException{
	...
	@PostMapping(value="/createStructure", produces=MediaType.APPLICATION_JSON_VALUE, consumes=MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<Structure> createStructure(@RequestBody @Valid StructureDTO structureDTO) throws OperationFailedException, AttributeNotFoundException  {
		List<StructureHasAttribute> structureHasAttributeList = new ArrayList<>();
	...
	public List<StructureDTO> getByType(@PathVariable("userType") String userType) throws OperationFailedException, AttributeNotFoundException{
