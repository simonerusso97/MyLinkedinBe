...
public class PostDTO {
	...
	public List<AttachedDTO> getAttachedList() {
		return attachedList;
	}

	public void setAttachedList(List<AttachedDTO> attachedDTOList) {
		this.attachedList = attachedDTOList;
	}
